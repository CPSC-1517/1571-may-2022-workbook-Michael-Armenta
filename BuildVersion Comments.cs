...
namespace WestWindSystem.Entities
{
    ...
    public class BuildVersion
    {
        ...
        //  entity class. It MUST match the other in the sql table.
        ...
        //3 syntax forms for the pkey (primary key) annotation
        ...
        // you do not wish to force the programmer to constantly concatenate
